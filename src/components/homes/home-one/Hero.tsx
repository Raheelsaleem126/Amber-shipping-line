...
import banner_img from "@/assets/img/other-images/man-hero2 (1).png"
            ...
            <div className="row align-items-end">
               <div className="col-lg-6">
                  <div className="banner__content">
                     <span className="sub-title" data-aos="fade-up" data-aos-delay="200">Welcome To</span>
                     <h2 className="title" data-aos="fade-up" data-aos-delay="400">Amber Shipping Line</h2>
